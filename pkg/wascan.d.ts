...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hfe058102f6f0b58d: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__ha6a7d8a25605ff02: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hd9c777cf39f1f631: (a: number, b: number, c: number) => void;
